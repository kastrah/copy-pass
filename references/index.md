...
**Load sequence during content pack:**
...
|---|---|---|
| `principles.md` | Planning phase | 10 universal principles from all 19 books |
| `triggers-and-motives.md` | Drafting hooks/CTAs | 8 Life-Force desires + 6 Prime Motives + 40 triggers |
| `headline-hooks-openers.md` | Opening any asset | Headline formulas, hook templates, opening techniques |
| `cta-framework.md` | Ending any asset | CTA formulas per platform, per reader mood |
| `persuasion-formulas.md` | Structuring the asset | AIDCA, PAS, FAB, 5P, Collier 6 Essentials, Sugarman Escalator |
| `objection-handling.md` | Pre-empting resistance | How to handle objections before they're raised |
